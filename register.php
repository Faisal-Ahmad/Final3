...
?>
	...
	<form name="form1" method="post" action="" onsubmit="return (valid());">
		<table class="table table-striped table-bordered table-condensed">
            ...
            <tr>
                <td>Full Name</td>
                <td><input type="text" name="fullname" class="form-control" onfocus="valid()" onblur="suggest()"></td>
            </tr>
            <tr>
				<td >Email</td>
				<td><input type="text" name="email" class="form-control" onfocus="valid()" onkeyup="suggest1()"><p id="emailSug"></p></td>
			</tr>
            <tr>
                <td>Phone Number</td>
